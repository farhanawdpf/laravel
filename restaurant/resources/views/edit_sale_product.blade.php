...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-sm-2 mb-2">
            <a class="btn btn-warning" href="{{ url('/pending_sell_list') }}">
                <i class="fa fa-money-check-alt" aria-hidden="true"></i> Pending Orders
            </a>    
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="row mt-2 ml-2">
            <div class="col-sm-2">
                <button type="submit" class="btn btn-success btn-lg mt-2" onclick="udpateSaleProduct()">UPDATE ORDER</button>
            </div>
        </div>
